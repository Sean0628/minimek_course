...
const mapState = (state) => {
  ...
  // These "bound classes" are available as fields in the sessions.
  const {Pilot} = session;
  ...
  // The toModelArray(0 method will give us an array of the
  ...
  const pilots = Pilot.all().toModelArray().map(pilotModel => {
    ...
    // Look up the associated Mech instance using the foregin-key
