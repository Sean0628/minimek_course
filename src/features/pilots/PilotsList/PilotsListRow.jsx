...
const mapState = (state, ownProps) => {
  ...
  if(Pilot.hasId(ownProps.pilotID)) {
    ...
    // We want to loog up piloModel.mech.mechType. Just in case the
    // relational fields are null, we'll do a couple savety checks as we go.
    // Look up the associated Mech instance using the foreign-key
    // field that defined in the Pilot Model class
